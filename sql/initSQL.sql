DROP DATABASE IF EXISTS testManager1;
CREATE DATABASE testManager1;
use testManager1;
...
CREATE TABLE questions (
    ...
    id_topics int unsigned not null,

    CONSTRAINT pk_questions PRIMARY KEY (id),
    CONSTRAINT fk_question_topics FOREIGN KEY(id_topics) REFERENCES topics(id)
);
