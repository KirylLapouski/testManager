        ...
        return (<div style={{ backgroundImage: 'url(\'https://mdbootstrap.com/img/Photos/Others/images/78.jpg\')', height: '100vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
            ...
            <div className="w-100 h-100 mask rgba-black-light d-flex justify-content-center align-items-center">
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <Hidden only={["sm", "xs"]}>
                        <div className="mb-4 white-text text-center text-md-left" style={{ maxWidth: '500px', marginRight: '30px' }}>
                            <h1 className="display-4 font-weight-bold">Тестовая платформа </h1>
                            <hr className="hr-light" />
                            <p>
                                Хотите узнать что-то новое, или повысить квалификацию? Вы нашли то, что искали!
                            </p>
                            <p className="mb-4 d-none d-md-block">
                                Представьте, что вы записались в идеальный университет, бесплатный, при этом предоставляющий тонны учебного материала в различных научных сферах
                            </p>
                            <Link to="/signUp" className="btn btn-indigo btn-lg">Зарегистрироваться
                                <i className="fa fa-graduation-cap ml-2"></i>
                            </Link>
                        </div>
                    </Hidden>
                    <div style={{ width: '500px', display: 'flex', justifyContent: 'center' }}>
                        <form method="POST" name="loginIn" className="form-signin " onSubmit={onSubmitHandler} style={{ borderRadius: '5px', padding: '20px', minHeight: '500px', display: 'flex', flexDirection: 'column', justifyContent: 'center', backgroundColor: '#fff', color: '#4f4f4f', width: '330px' }}>
                            ...
                            <a role="button" href="http://localhost:3000/auth/yandex" className="btn red btn-block  waves-effect waves-light"><i className="fa fa-yahoo" aria-hidden="true"></i> yandex</a>
