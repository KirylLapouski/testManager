...
class AddNewQuesrionInTest extends React.Component {
    render() {
        return <ExpansionPanel className="z-depth-1 container" style={{ margin: '0 auto' }}>
...
AddNewQuesrionInTest.propTypes = {
...
export default AddNewQuesrionInTest
