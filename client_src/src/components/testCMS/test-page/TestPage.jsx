...
class TestPage extends React.Component {
    ...
    render() {
        var { handleChange, handleSubmitNewQuestionForm, name, weight, description, questions, openedItem, toggleOpenItem } = this.props
        return <div>
            <TestList questions={questions} openedItem={openedItem} toggleOpenItem={toggleOpenItem} />
            <AddNewQuestionInTest handleChange={handleChange} handleSubmitNewQuestionForm={handleSubmitNewQuestionForm} name={name} weight={weight} description={description} />
